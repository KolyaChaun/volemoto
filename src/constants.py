...
PARTS_SUBCATS = [
    {"key": "wheels",     "label": "Шини та диски",       "sub": ["Колеса", "Шини", "Диски"]},
    {"key": "filter",     "label": "Фільтра/Масла",       "sub": []},
    {"key": "fuel_tanks", "label": "Паливні баки",        "sub": []},
    {"key": "lighting",   "label": "Освітлення",          "sub": ["Передні фари", "Задні ліхтарі", "Покажчики повороту", "Додаткове освітлення", "Електрообладнання"]},
    {"key": "plastic",    "label": "Пластик та крила",             "sub": []},
    ...
    {"key": "engine",     "label": "Двигун",              "sub": []},
    {"key": "protection", "label": "Захист",              "sub": []},
    {"key": "exhaust",    "label": "Вихлопна система",    "sub": []},
    {"key": "footrest",   "label": "Підніжки",            "sub": []},
    {"key": "mirrors",    "label": "Дзеркала",            "sub": []},
    {"key": "cases",      "label": "Кофри",               "sub": ["Системи кріплення"]},
    {"key": "seats",      "label": "Сидіння, Спинки та ручки",             "sub": []},
